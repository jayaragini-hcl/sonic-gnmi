...
const (
	srvTestCertFile   = "../testdata/crl/server_test_cert.pem"
	srvTestKeyFile    = "../testdata/crl/server_test_key.pem"
	srvTestKeyLink    = "../testdata/crl/server_key.lnk"
	srvTestCertLink   = "../testdata/crl/server_cert.lnk"
	certzTestMetaFile = "../testdata/grpc-version.json"
)
...
func TestSrvAdvConfig_NoCA(t *testing.T) {
...
func TestSrvConfig_DeepCoverage(t *testing.T) {
	...
	t.Run("SrvTestConfig_WriteError_Coverage", func(t *testing.T) {
	...
	t.Run("SrvAdvConfig_FullLogic_Handshake", func(t *testing.T) {
		cfg := &Config{
			CaCertFile:    caFile,
			CaCertLnk:     caFile,
			SrvCertFile:   srvCert,
		...
		// To cover the INSIDE of GetRootCertificates, we extract the options
		// Note: We cast to advancedtls.Options if the library allows,
		// but since we want coverage on server.go, we just need to trigger the calls.
	...
	t.Run("SrvAdvConfig_CRL_Failures", func(t *testing.T) {
...
func TestSrvTestConfig_LogsAndReturns(t *testing.T) {
	// 1. Force error in the FIRST WriteFile (Server Certificate)
	t.Run("Coverage_CertWriteError", func(t *testing.T) {
	...
	t.Run("Coverage_KeyWriteError", func(t *testing.T) {
